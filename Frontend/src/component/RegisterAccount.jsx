    ...
    <div className="flex justify-center items-center min-h-screen p-10">
      <div className="bg-white p-8  w-[50%] ">
        ...
        <div className="flex justify-center mb-6 gap-4">
          <button
            className={`px-4 py-1 w-[40%] rounded-full font-semibold ${isCandidate ? 'bg-[#00A7AC] text-white' : 'bg-gray-200'}`}
            onClick={() => {setIsCandidate(true); setCompany(false)}}
          >
            Candidate
          </button>
          <button
            className={`px-4 py-1 w-[40%] rounded-full font-semibold ${company ? 'bg-[#00A7AC] text-white' : 'bg-gray-200'}`}
            onClick={() =>{ setIsCandidate(false); setCompany(true)} }
          >
            Company
          </button>
        </div>
        ...
        <form className='border w-[100%] p-5 rounded-xl'>
          ...
          <div className="mt-4 flex items-center">
            ...
            <label htmlFor="terms" className="text-gray-700">Here, I will agree company terms & conditions.</label>
          </div>
          <button
            type="submit"
